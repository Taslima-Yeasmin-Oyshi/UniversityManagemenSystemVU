...
public class UpdateStudent extends JFrame implements ActionListener {
    ...
    UpdateStudent() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                tfcourse.setText(rs.getString("program"));
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == submit) {
            ...
            try {
                String query = "update student set address='" + address + "', phone='" + phone + "', email='" + email + "', program='" + course + "', department='" + branch + "' where rollno='" + rollno + "'";
                Conn con = new Conn();
