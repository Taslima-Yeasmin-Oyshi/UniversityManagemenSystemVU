...
public class AddStudent extends JFrame implements ActionListener {
    ...
    JTextField tfname, tffname, tfaddress, tfphone, tfemail, tfx, tfxii, tfnid, tfrollno, tfsem; // Added tfsem
    ...
    AddStudent() {
        ...
        JLabel lblsem = new JLabel("Semester"); // Label for semester
        lblsem.setBounds(400, 200, 200, 30);
        lblsem.setFont(new Font("serif", Font.BOLD, 20));
        add(lblsem);

        tfsem = new JTextField(); // Text field for semester
        tfsem.setBounds(600, 200, 150, 30);
        add(tfsem);
        ...
        JLabel lblxii = new JLabel("S.S.C");
        ...
        lblnid.setBounds(50, 400, 200, 30);
        ...
        String branch[] = {"CSE", "EEE", "BBA", "English", "Pharmacy", "Political Science", "Islamic History and Culture", "Law and Human Rights", "Journalism,Communication and Media Studies", "Public Health", "Economics", "Sociology"};
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == submit) {
            ...
            String rollno = tfrollno.getText(); // Fetch roll number from the text field
            String semester = tfsem.getText(); // Fetch semester from the text field
            ...
            String aadhar = tfnid.getText();
            String course = (String) cbcourse.getSelectedItem();
            String branch = (String) cbbranch.getSelectedItem();

            try {
                String query = "insert into student values('" + name + "', '" + fname + "', '" + rollno + "', '" + semester + "', '" + dob + "', '" + address + "', '" + phone + "', '" + email + "', '" + x + "', '" + xii + "', '" + aadhar + "', '" + course + "', '" + branch + "')";
