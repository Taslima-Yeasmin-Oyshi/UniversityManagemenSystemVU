...
public class StudentFeeForm extends JFrame implements ActionListener {
    ...
    StudentFeeForm() {
        ...
        String branch[] = {"CSE", "EEE", "ENGLISH", "PHARMACY", "LAW AND HUMAN RIGHTS", "POLITICAL SCIENCE", "JOURNALISM",  "ECONOMICS", "BBA"};
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == update) {
            ...
            try {
                Conn c = new Conn();
                ResultSet rs = c.s.executeQuery("select * from fee where department = '"+course+"'");
                while(rs.next()) {
