...
public class UpdateTeacher extends JFrame implements ActionListener{
    ...
    UpdateTeacher() {
        ...
        JLabel lblrollnumber = new JLabel("Select Employ ID");
        ...
        try {
            ...
            while(rs.next()) {
                crollno.add(rs.getString("employ_id"));
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        JLabel lblrollno = new JLabel("Emloy ID");
        ...
        try {
            Conn c = new Conn();
            String query = "select * from teacher where employ_id='"+crollno.getSelectedItem()+"'";
            ResultSet rs = c.s.executeQuery(query);
            while(rs.next()) {
                labelname.setText(rs.getString("name"));
                labelfname.setText(rs.getString("father_name"));
                labeldob.setText(rs.getString("dateofbirth"));
                tfaddress.setText(rs.getString("address"));
                tfphone.setText(rs.getString("phone"));
                tfemail.setText(rs.getString("email"));
                labelx.setText(rs.getString("ssc"));
                labelxii.setText(rs.getString("hsc"));
                labelnid.setText(rs.getString("nid"));
                labelrollno.setText(rs.getString("employ_id"));
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == submit) {
            ...
            try {
                String query = "update teacher set address='"+address+"', phone='"+phone+"', email='"+email+"', Qualification='"+course+"', department='"+branch+"' where employ_id='"+rollno+"'";
                Conn con = new Conn();
                con.s.executeUpdate(query);
                
                JOptionPane.showMessageDialog(null, "Teachert Details Updated Successfully");
                setVisible(false);
            } catch (Exception e) {
                e.printStackTrace();
            }
